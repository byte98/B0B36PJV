...
{
    private ArrayList<BicycleHolder> holders;
    private int max_holders = 4;
    
    public Car()
    {
        this.holders = new ArrayList<BicycleHolder>(this.max_holders);
    }
    
    private void addHolder(BicycleHolder holder)
    {
    ...
    public String toString()
    {
       ...
       for (BicycleHolder h : this.holders)
       {
           reti += h.toString() + "\n";
       }
    ...
    {
        this.addHolder(new BicycleHolder(b));
    }
